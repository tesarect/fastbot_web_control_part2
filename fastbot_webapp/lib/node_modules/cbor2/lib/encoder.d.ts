 ...
 */
declare function writeSymbol(sym: Symbol, w: Writer, opts: RequiredEncodeOptions): undefined;
/**
...
export { ENCODED, type ToJSON, cdeEncodeOptions, clearEncoder, dcborEncodeOptions, defaultEncodeOptions, encode, encodedNumber, registerEncoder, writeArray, writeBigInt, writeFloat, writeInt, writeLength, writeNumber, writeString, writeSymbol, writeTag, writeUint8Array, writeUnknown };
